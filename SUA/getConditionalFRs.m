function [conditionFRs, binMeanS] = getConditionalFRs(spikeTs,eventTs, conditionIdxs, windowMs, binSizesMs)
...
conditionFRs = nan(numConditions,numBins);
...
for c = 1:numConditions
    ...
    conditionFRs(c, 1:numBins) = mean(eventBinnedHz,1);
